...
public interface ProgettoRepository {
    ...
    /**
     * Saves [p] inside the caller's transaction; saving the same Progetto again is allowed.
     * @throws IllegalStateException if the database already holds a Progetto with another id
     *   (programmer error: one Progetto per project database).
     */
