...
- AC-559 (re-scoped 2026-09-24, verifier D1 finding: the global check is owned by the wave-16 screen blocks, AC-578b/AC-589b) No emoji and no ▶ ⏸ ⏹ glyphs as UI icons in snastro.ui.stile and the snastro.ui.testi constants the block touches (test walks src/main/kotlin/snastro/ui/stile); '▶ estratto' becomes 'Estratto' + Icona.Listen
