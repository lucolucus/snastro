...
consumes_rm:
  - "elenco-progetti"
triggers:
  - "CreaProgetto (via SessioneProgetto.crea)"
  - "ApriProgetto (via SessioneProgetto.apri)"
---
# schermata-progetti — S1 · Progetti

## What to do
S1 list + 'Nuovo progetto' + 'Apri progetto…' (R3).

### Consumes read-models: elenco-progetti
### Triggers: CreaProgetto (via SessioneProgetto.crea), ApriProgetto (via SessioneProgetto.apri)
...
## Dependencies
- Blocks built first: `crea-progetto` (wave 4), `elenco-progetti` (wave 5), `ui-fondamenta` (wave 6)
