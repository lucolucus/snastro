...
### Consumes read-models: trascritto-view, documento
### Triggers: —
...
## Dependencies
- Blocks built first: `trascritto-view` (wave 5), `documento` (wave 4), `ui-fondamenta` (wave 6)
...
Sources: ADRs 0002, 0003, 0005, 0010, 0012 (.mismagent/decisions/); features/trascrizione-con-parlanti/UI/ux-proposal.md S3 (+ R1, R8, amendment 2026-09-24 S3 read-only in R1), manifest delta 2026-09-24-packaging (User decisions 2026-09-24).
