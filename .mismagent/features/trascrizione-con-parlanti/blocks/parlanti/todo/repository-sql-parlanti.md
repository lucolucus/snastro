...
## What to do
ParlanteRepositorySql (root + impronta_vocale replace), AttribuzioneRepositorySql; wal_checkpoint(TRUNCATE) AFTER commit of an EliminaParlante (R23).

## Tasks
- AC-114 Round-trip di Parlante con impronte (BLOB float32 little-endian) e di Attribuzione
