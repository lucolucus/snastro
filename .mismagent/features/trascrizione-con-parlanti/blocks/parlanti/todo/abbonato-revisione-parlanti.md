...
related_adrs:
  ...
  - "0012"
---
# abbonato-revisione-parlanti — Abbonato sincrono agli eventi di Revisione → revisione-policy
...
## Dependencies
- Blocks built first: `revisione-policy` (wave 4)
...
Sources: ADRs 0002, 0003, 0012 (.mismagent/decisions/); features/trascrizione-con-parlanti/tactical-model.md § Parlanti Policy, ADR 0012.
