...
related_adrs:
  ...
  - "0019"
view_shape:
  voci: "List<{voceId, parlanteId?, nome?, tipoParlante?: TipoParlanteVista}>"
view_sources:
  voci: "voceId ← voci-per-parlanti; parlanteId ← Attribuzione; nome, tipoParlante ← Parlante"
---
# identificazione-voci — IdentificazioneVoci — fetta Parlanti (S3)

## What to do
Voce → Parlante identity for S3 (R1 split).

### view_shape (field ← source)
- `voci`: List<{voceId, parlanteId?, nome?, tipoParlante?: TipoParlanteVista}> ← voceId ← voci-per-parlanti; parlanteId ← Attribuzione; nome, tipoParlante ← Parlante

## Tasks
- AC-169 La vista espone per ogni Voce voceId e, se attribuita, parlanteId, nome e tipoParlante; senza Attribuzione solo voceId
...
Sources: ADRs 0002, 0003, 0006, 0007, 0009, 0012, 0019 (.mismagent/decisions/); features/trascrizione-con-parlanti/UI/ux-proposal.md S3 (+ R1).
