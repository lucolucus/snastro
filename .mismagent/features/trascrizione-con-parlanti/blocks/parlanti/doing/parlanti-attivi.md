...
related_adrs:
  ...
  - "0012"
view_shape:
  parlanti: "List<{parlanteId, nome, tipoParlante}>"
view_sources:
  parlanti: "← Parlante (attivo, same Progetto)"
---
# parlanti-attivi — ParlantiAttivi ('altri ▾')

## What to do
Attivo Parlanti of the Progetto, ordered by Nome.

### view_shape (field ← source)
- `parlanti`: List<{parlanteId, nome, tipoParlante}> ← ← Parlante (attivo, same Progetto)

## Tasks
- AC-174 La vista espone parlanteId, nome e tipoParlante dei soli Parlanti attivi del Progetto, in ordine di Nome
...
Sources: ADRs 0002, 0003, 0006, 0007, 0009, 0012 (.mismagent/decisions/); features/trascrizione-con-parlanti/UI/ux-proposal.md S3.
