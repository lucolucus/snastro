---
id: "abbonato-registrazione-aggiunta"
type: "adapter"
...
related_adrs:
  ...
  - "0012"
---
# abbonato-registrazione-aggiunta — Abbonato sincrono a RegistrazioneAggiunta → AvviaElaborazione

## What to do
AbbonatoSincrono on RegistrazioneAggiunta that runs AvviaElaborazioneServizio in the same transaction (R2 — the policy moved from Progetto to Trascrizione).

## Tasks
- AC-140 Pubblicare RegistrazioneAggiunta dentro una transazione crea l'Elaborazione in_attesa nella stessa transazione
- AC-141 Se AvviaElaborazione restituisce Errore, l'intero AggiungiRegistrazione è annullato

## Dependencies
- Blocks built first: `avvia-elaborazione` (wave 4)
...
Sources: ADRs 0002, 0003, 0012 (.mismagent/decisions/); features/trascrizione-con-parlanti/tactical-model.md § Progetto Policy (+ R2), ADR 0012.
