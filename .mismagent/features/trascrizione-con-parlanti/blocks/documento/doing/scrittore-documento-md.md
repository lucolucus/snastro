...
related_adrs:
  ...
  - "0012"
---
# scrittore-documento-md — Scrittore atomico dei .md

## What to do
ScrittoreDocumento over documenti/: write *.tmp then atomic move/replace; never reads (ADR 0010 enforced_by).
