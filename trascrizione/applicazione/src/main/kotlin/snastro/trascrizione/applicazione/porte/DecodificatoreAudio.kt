 ...
 * exception (ADR 0003) — never an `Esito`. Contract: `DecodificatoreAudioContratto`.
 */
public interface DecodificatoreAudio {
    ...
    /** The samples of [intervallo]: exactly `(fineMs - inizioMs) * 16` of them, the same as that slice of [tutti]. */
